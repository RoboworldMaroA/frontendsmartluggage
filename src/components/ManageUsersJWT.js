...
const ManageUsers = ({item}) => {
    ...
    useEffect(() => {
        ...
        fetch("https://smartluggagebackendjwt-c266cf5456e9.herokuapp.com/displayUsers").then((response) => response.json()).then((UserData) => {
    ...
    //     e.preventDefault();
    //             const result = await fetch("https://smartluggagebackendjwt-c266cf5456e9.herokuapp.com/displayUsers"+"/" + id, {
    //         method: "DELETE",
    //     })
    //                 .then((res) => res.json())
    ...
    const deleteCustomer = async (e) => {
        ...
        const result2 = await fetch("https://smartluggagebackendjwt-c266cf5456e9.herokuapp.com/displayUsers/" + id, {
            method: "DELETE",
        })
            .then((res) => res.json())
            .then((data) => console.log(data))
        ...
        const body2 = await result2.json().catch(err => console.log(err.res));
        setUserData(body2);
    }
            ...
            <div>
                {displayUserDetail
                    ? userData.map((UserData) => {
                        ...
                        <div className="row">
                            <form className="col s12" onSubmit={(e) => deleteCustomer(e)}>
                                <div className="row">
