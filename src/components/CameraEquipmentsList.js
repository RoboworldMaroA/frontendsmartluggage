...
const CameraEquipmentsList = ({}) => {
    ...
    const [items, setItems] = useState([
        {itemName: 'Camera', quantity: 1, isSelected: false, weight: 0.1},
    ...
    useEffect(() => {
            ...
            const cameraData = window.localStorage.getItem('CAMERA_EQUIPMENTS_DATA');
...
export default CameraEquipmentsList;