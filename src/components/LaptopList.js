...
const LaptopList=({})=>{
    ...
    const [items, setItems] = useState([
        {itemName: 'Laptop Bag', quantity: 0, isSelected: false, weight: 1.1},
        {itemName: 'Pen Drive', quantity: 0, isSelected: false, weight: 0.02},
    ]);
    ...
    useEffect(() => {
            ...
            const cameraData = window.localStorage.getItem('LAPTOP_DATA');
    ...
    useEffect(() => {
            console.log(items);
            window.localStorage.setItem('LAPTOP_DATA', JSON.stringify(items));
